...
Functionality: **_Displays contents of a file in the console. Simplest possible file project_**
...
git clone https://github.com/jammazwan/xad_FileToConsoleLog.git
cd jammazwan.shared
mvn install 
```
...
_run XadTest and observe console._
...
so you can focus only on what is required to demo the **FileToConsoleLog** feature **_in isolation_**.
...
The prefix **xad** is used for maintaining sort order in a directory, providing packaging, and is otherwise meaningless. The x stands for _example_.
